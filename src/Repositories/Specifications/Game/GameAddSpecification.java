package Repositories.Specifications.Game;
...
public class GameAddSpecification implements SqlStatementSpecification {
    String firstName;
    String  lastName;
    String email;
    String userName;
    ...
    public GameAddSpecification(UserDTO entity)
    {
